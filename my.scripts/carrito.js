...
botonComprar.addEventListener('click', () => {
    swal("Estas a punto de terminar el proceso de seleccion. ¿Desea continuar para abonar el total?", {
            buttons: {
                cancel: "¡Quiero seguir eligiendo productos!",
                catch: {
                    text: "Quiero abonar mi compra.",
                    value: "Cancelar.",
                },
                defeat: true,
            },
